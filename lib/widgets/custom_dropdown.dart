...
class _CustomDropdownWithOtherState extends State<CustomDropdownWithOther> {
  ...
  void initState() {
    super.initState();
    otherController = widget.controller ?? TextEditingController();
    final dropdownItems = [...widget.items, 'Other'];
    // Set initial value from controller if present
    if (widget.controller != null && widget.controller!.text.isNotEmpty) {
      if (dropdownItems.contains(widget.controller!.text)) {
        selectedValue = widget.controller!.text;
        showOtherField = false;
      } else {
        selectedValue = 'Other';
        showOtherField = true;
        otherController.text = widget.controller!.text;
      }
    } else {
          ...
          onChanged: (value) {
            setState(() {
              ...
              if (!showOtherField) {
                ...
                if (widget.controller != null) widget.controller!.text = otherController.text;
              }
            });
          },
        ),
