...
class _ChecksheetFormViewState extends State<ChecksheetFormView> {
  ...
  List<Map<String, Widget>> _buildFieldWidgets(ChecksheetFormProvider provider) {
    ...
    return [
      ...
      {"section": sectionSpacing},
      {
        "Bogie Frame Condition": CustomDropdownWithOther(
          label: "Bogie Frame Condition",
          items: ["Overaged", "Cracked", "Worn out", "Good"],
          enableColoredDropdown: true,
          controller: provider.bogieFrameConditionController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Bolster": CustomDropdownWithOther(
          label: "Bolster",
          items: ["Cracked", "Bent", "Good"],
          enableColoredDropdown: true,
          controller: provider.bolsterController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Bolster Suspension Bracket": CustomDropdownWithOther(
          label: "Bolster Suspension Bracket",
          items: ["Cracked", "Corroded", "Good"],
          enableColoredDropdown: true,
          controller: provider.bolsterSuspensionBracketController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Lower Spring Seat": CustomDropdownWithOther(
          label: "Lower Spring Seat",
          items: ["Cracked", "Worn out", "Good"],
          enableColoredDropdown: true,
          controller: provider.lowerSpringSeatController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Axle Guide": CustomDropdownWithOther(
          label: "Axle Guide",
          items: ["Worn", "Misalign", "Good"],
          enableColoredDropdown: true,
          controller: provider.axleGuideController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Axle Guide Assembly": CustomDropdownWithOther(
          label: "Axle Guide Assembly",
          items: ["Worn out", "Damaged", "Good"],
          enableColoredDropdown: true,
          controller: provider.axleGuideAssemblyController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Protective Tubes": CustomDropdownWithOther(
          label: "Protective Tubes",
          items: ["Cracked", "Good"],
          enableColoredDropdown: true,
          controller: provider.protectiveTubesController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Anchor Links": CustomDropdownWithOther(
          label: "Anchor Links",
          items: ["Damaged", "Good"],
          enableColoredDropdown: true,
          controller: provider.anchorLinksController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Side Bearer": CustomDropdownWithOther(
          label: "Side Bearer",
          items: ["Damaged", "Good"],
          enableColoredDropdown: true,
          controller: provider.sideBearerController,
        ),
      },
      {"section": sectionSpacing},
      ...
      {"section": sectionSpacing},
      {
        "Cylinder Body & Dome Cover": CustomDropdownWithOther(
          label: "Cylinder Body & Dome Cover",
          items: ["GOOD", "WORN OUT", "DAMAGED"],
          enableColoredDropdown: true,
          controller: provider.cylinderBodyController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Piston & Trunnion Body": CustomDropdownWithOther(
          label: "Piston & Trunnion Body",
          items: ["GOOD", "WORN OUT", "DAMAGED"],
          enableColoredDropdown: true,
          controller: provider.pistonTrunnionController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Adjusting Tube and Screw": CustomDropdownWithOther(
          label: "Adjusting Tube and Screw",
          items: ["GOOD", "WORN OUT", "DAMAGED"],
          enableColoredDropdown: true,
          controller: provider.adjustingTubeController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Plunger Spring": CustomDropdownWithOther(
          label: "Plunger Spring",
          items: ["GOOD", "WORN OUT", "DAMAGED"],
          enableColoredDropdown: true,
          controller: provider.plungerSpringController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Tee Bolt, Hex Nut": CustomDropdownWithOther(
          label: "Tee Bolt, Hex Nut",
          items: ["GOOD", "WORN OUT", "DAMAGED"],
          enableColoredDropdown: true,
          controller: provider.teeBoltHexNutController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Pawl and Pawl Spring": CustomDropdownWithOther(
          label: "Pawl and Pawl Spring",
          items: ["GOOD", "WORN OUT", "DAMAGED"],
          enableColoredDropdown: true,
          controller: provider.pawlAndPawlSpringController,
        ),
      },
      {"section": sectionSpacing},
      {
        "Dust Excluder": CustomDropdownWithOther(
          label: "Dust Excluder",
          items: ["GOOD", "WORN OUT", "DAMAGED"],
          enableColoredDropdown: true,
          controller: provider.dustExcluderController,
        ),
      },
    ];
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Divider(),
            _summaryRow("Bogie No.", provider.bogieNoController.text),
            _summaryRow("Maker & Year Built", provider.makerYearBuiltController.text),
            _summaryRow("Incoming Div. & Date", provider.incomingDivDateController.text),
            _summaryRow("Deficit of component (if any)", provider.deficitComponentsController.text),
            _summaryRow("Date of IOH", provider.dateOfIohController.text),
            _summaryRow("Bogie Frame Condition", provider.bogieFrameConditionController.text),
            _summaryRow("Bolster", provider.bolsterController.text),
            _summaryRow("Bolster Suspension Bracket", provider.bolsterSuspensionBracketController.text),
            _summaryRow("Lower Spring Seat", provider.lowerSpringSeatController.text),
            _summaryRow("Axle Guide", provider.axleGuideController.text),
            _summaryRow("Axle Guide Assembly", provider.axleGuideAssemblyController.text),
            _summaryRow("Protective Tubes", provider.protectiveTubesController.text),
            _summaryRow("Anchor Links", provider.anchorLinksController.text),
            _summaryRow("Side Bearer", provider.sideBearerController.text),
            _summaryRow("Cylinder Body & Dome Cover", provider.cylinderBodyController.text),
            _summaryRow("Piston & Trunnion Body", provider.pistonTrunnionController.text),
            _summaryRow("Adjusting Tube and Screw", provider.adjustingTubeController.text),
            _summaryRow("Plunger Spring", provider.plungerSpringController.text),
            _summaryRow("Tee Bolt, Hex Nut", provider.teeBoltHexNutController.text),
            _summaryRow("Pawl and Pawl Spring", provider.pawlAndPawlSpringController.text),
            _summaryRow("Dust Excluder", provider.dustExcluderController.text),
          ],
        ),
      ),
    );
