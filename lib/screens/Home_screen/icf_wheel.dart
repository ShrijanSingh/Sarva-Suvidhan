...
class _IcfWheelViewState extends State<IcfWheelView> {
  ...
  List<Map<String, Widget>> _buildFields(IcfWheelProvider p) {
    ...
    return [
      ...
      {"section": sectionSpacing},
      {
        "Permissible Variation - Same Axle": CustomTextField(
      ...
      {"section": sectionSpacing},
      {
        "Permissible Variation - Same Bogie": CustomTextField(
          label: "Permissible Variation - Same Bogie",
          controller: p.variationSameBogieController,
          value: p.variationSameBogieController.text,
        ),
      },
      {"section": sectionSpacing},
      {
        "Permissible Variation - Same Coach": CustomTextField(
          label: "Permissible Variation - Same Coach",
          controller: p.variationSameCoachController,
          value: p.variationSameCoachController.text,
        ),
      },
      {"section": sectionSpacing},
      {
        "Wheel Profile (RDSO 91146 Alt.2)": CustomTextField(
      ...
      {"section": sectionSpacing},
      {
        "Intermediate WWP (RDSO 92082)": CustomTextField(
      ...
      {"section": sectionSpacing},
      {
        "Bearing Seat Diameter": CustomTextField(
          ...
          controller: p.bearingSeatDiameterController,
          value: p.bearingSeatDiameterController.text,
        ),
      },
      {"section": sectionSpacing},
      {
        "Roller Bearing Outer Dia": CustomDropdownWithOther(
      ...
      {"section": sectionSpacing},
      {
        "Roller Bearing Bore Dia": CustomDropdownWithOther(
      ...
      {"section": sectionSpacing},
      {
        "Roller Bearing Width": CustomDropdownWithOther(
      ...
      {"section": sectionSpacing},
      {
        "Axle Box Housing Bore Dia": CustomDropdownWithOther(
      ...
      {"section": sectionSpacing},
      {
        "Wheel Disc Width": CustomDropdownWithOther(
